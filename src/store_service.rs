...
impl<'a> StoreService<'a> {
    ...
    pub async fn get_app_list(
        ...
        let query = format!("?key={}&if_modified_since={}&have_description_language={}&include_games={}&include_dlc={}&include_software={}&include_videos={}&include_hardware={}&last_appid={}&max_results={}", self.api.get_key()?, if_modified_since.unwrap_or_default(), have_description_language.unwrap_or_default(), include_games.unwrap_or_default(), include_dlc.unwrap_or_default(), include_software.unwrap_or_default(), include_videos.unwrap_or_default(), include_hardware.unwrap_or_default(), last_appid.unwrap_or_default(), max_results.unwrap_or_default());
        let data = self
            .api
