...
pub struct TicketDota2Beta<'a> {
    api: &'a mut crate::WebApi,
}

impl<'a> TicketDota2Beta<'a> {
    ...
    pub async fn steam_account_valid_for_badge_type(
        ...
        let data = self
            .api
            .request(&format!(
                "IDOTA2Ticket_205790/SteamAccountValidForBadgeType/v1/{}",
                &query
            ))
            .await?;
    ...
    pub async fn get_steam_id_for_badge_id(
        ...
        let data = self
            .api
            .request(&format!(
                "IDOTA2Ticket_205790/GetSteamIDForBadgeID/v1/{}",
                &query
            ))
            .await?;
    ...
    pub async fn claim_badge_reward(
        ...
        let data = self
            .api
            .request(&format!(
                "IDOTA2Ticket_205790/ClaimBadgeReward/v1/{}",
                &query
            ))
            .await?;
